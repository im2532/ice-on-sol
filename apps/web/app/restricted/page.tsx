...
export default function RestrictedPage() {
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center gap-5 px-4 py-24 text-center">
      <Mark size={56} />
      <h1 className="display text-2xl font-bold">ICEmarkets isn&apos;t available in your region</h1>
      <p className="text-sm leading-relaxed text-body">
        ICEmarkets is not offered to persons located in the United States, the United Kingdom, or any
        sanctioned jurisdiction, in line with our compliance policy. If you believe this is a mistake, reach
        out on{" "}
        <a
