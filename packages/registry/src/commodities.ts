...
export const COMMODITIES: Commodity[] = [
  ...
  { symbol: "USO", name: "Oil fund exposure", category: "energy", unit: "1 unit", unitShort: "unit", tier: "AHours", session: S.CmeGlobex, phase: "v1.1", emoji: "📈",
  ...
  { symbol: "RB", name: "Gasoline", category: "energy", unit: "1 gallon", unitShort: "gal", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "⛽",
    oracle: sb("nymex_rbob_front_month"), params: P.B },
  { symbol: "HO", name: "Heating Oil", category: "energy", unit: "1 gallon", unitShort: "gal", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🏠",
    oracle: sb("nymex_ho_front_month"), params: P.B },

  // AGRICULTURE ----------------------------------------------------------
  { symbol: "LBR", name: "Lumber", category: "agriculture", unit: "1,000 board ft", unitShort: "mbf", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🪵",
  ...
  { symbol: "ZM", name: "Soybean Meal", category: "agriculture", unit: "1 short ton", unitShort: "ton", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🥣",
    oracle: sb("cbot_soymeal_front_month"), params: P.B },
  { symbol: "ZL", name: "Soybean Oil", category: "agriculture", unit: "1 lb", unitShort: "lb", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🫙",
    oracle: sb("cbot_soyoil_front_month"), params: P.B },
  { symbol: "ZR", name: "Rice", category: "agriculture", unit: "1 cwt", unitShort: "cwt", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🍚",
    oracle: sb("cbot_rice_front_month"), params: P.B },
  { symbol: "ZO", name: "Oats", category: "agriculture", unit: "1 bushel", unitShort: "bu", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🌾",
  ...
  { symbol: "CT", name: "Cotton", category: "agriculture", unit: "1 lb", unitShort: "lb", tier: "B", session: S.IceUs, phase: "v1.1", emoji: "☁️",
    oracle: sb("ice_cotton_front_month"), params: P.B },
  { symbol: "OJ", name: "Orange Juice", category: "agriculture", unit: "1 lb", unitShort: "lb", tier: "B", session: S.IceUs, phase: "v1.1", emoji: "🍊",
    oracle: sb("ice_oj_front_month"), params: P.B },
  { symbol: "DC", name: "Milk", category: "agriculture", unit: "1 cwt (Class III)", unitShort: "cwt", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🥛",
  ...
  { symbol: "GF", name: "Feeder Cattle", category: "livestock", unit: "1 lb", unitShort: "lb", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🐂",
    oracle: sb("cme_feeder_cattle_front_month"), params: P.B },
  { symbol: "HE", name: "Lean Hogs", category: "livestock", unit: "1 lb", unitShort: "lb", tier: "B", session: S.CmeGlobex, phase: "v1.1", emoji: "🐖",
  ...
  { symbol: "NUGGETS", name: "10 pc chicken nuggets", displayName: "10 pc McNuggets", category: "fast_food", unit: "1 order", unitShort: "order", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🍗", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "BIGBURGER", name: "Flame-grilled burger", displayName: "Whopper", category: "fast_food", unit: "1 sandwich", unitShort: "sandwich", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🍔", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "CHIXSAND", name: "Chicken sandwich", displayName: "Chick-fil-A Sandwich", category: "fast_food", unit: "1 sandwich", unitShort: "sandwich", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🥪", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "TACO", name: "Crunchy taco", displayName: "Crunchy Taco", category: "fast_food", unit: "1 taco", unitShort: "taco", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🌮", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "BURRITO", name: "Chicken burrito", displayName: "Chicken Burrito", category: "fast_food", unit: "1 burrito", unitShort: "burrito", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🌯", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "LATTE", name: "Grande latte", displayName: "Grande Latte", category: "fast_food", unit: "1 drink", unitShort: "drink", tier: "C", session: S.Slow, phase: "v1.1", emoji: "☕", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "PIZZA", name: "Large pepperoni pizza", displayName: "Large Pepperoni", category: "fast_food", unit: "1 pizza", unitShort: "pizza", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🍕", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "DBLBURGER", name: "Double cheeseburger", displayName: "Double-Double", category: "fast_food", unit: "1 burger", unitShort: "burger", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🍔", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "BACONBRGR", name: "Bacon burger", displayName: "Baconator", category: "fast_food", unit: "1 burger", unitShort: "burger", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🥓", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "SPICYCHIX", name: "Spicy chicken sandwich", displayName: "Popeyes Sandwich", category: "fast_food", unit: "1 sandwich", unitShort: "sandwich", tier: "C", session: S.Slow, phase: "v1.1", emoji: "🌶️", oracle: manual(7 * 86400), params: P.CManual },
  { symbol: "MEDCOFFEE", name: "Medium coffee", displayName: "Dunkin Medium Coffee", category: "fast_food", unit: "1 coffee", unitShort: "coffee", tier: "C", session: S.Slow, phase: "v1.1", emoji: "☕", oracle: manual(7 * 86400), params: P.CManual },
  ...
  ...([
    ...
    phase: ["ETB151", "ETBPRISM", "ZARDBASE", "MOONBREON", "UMBREONEX", "PIKAEX238"].includes(symbol) ? "mvp" : "v1.1",
...
/** Index coins (D6 "baskets"). Created on the Peg Desk as Composite commodities. Phase v1.1. */
export const INDEX_COINS: Commodity[] = [
  { symbol: "PMX", name: "Precious Metals Index", category: "metals", unit: "1 index unit", unitShort: "idx", tier: "AHours", session: S.CmeGlobex, phase: "v1.1", emoji: "💎",
  ...
  { symbol: "CS2X", name: "CS2 Skins Index", category: "cs2_skins", unit: "1 index unit", unitShort: "idx", tier: "B", session: S.Continuous, phase: "v1.1", emoji: "🎮",
...
export const CATEGORY_LABEL: Record<Commodity["category"], string> = {
  ...
  cs2_skins: "CS2 skins", game_gold: "Game gold", trading_cards: "Trading cards", water: "Water", cars: "Cars",
};
